...
const Tomorrow = (props) => {
    ...
    const getTodayTasks = async () => {
        ...
        await Axios("challange/tomorrow", param, 'POST').then(async (response) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.headerStyle}>
                ...
                <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
                    ...
                    <View style={{ marginHorizontal: wp(4) }}>
                        <Text style={{ textAlign: "center", fontSize: 25 }}>Tommorow</Text>
                        <Text style={{ textAlign: "center", fontSize: 9 }}>13-7-2021</Text>
                    </View>
                </View>
            ...
            <View style={{ flexDirection: "row", marginHorizontal: wp(5), marginTop: wp(10) }}>
                <Text style={{ fontWeight: "bold", color: Colors.LightGray }}>Your tomorrow habit</Text>
            </View>
            <FlatList
